...
```sh
go run ./engine/cmd/antedom serve --site docs         # serve the docs site on 127.0.0.1:26833, live-reloading on change
go run ./engine/cmd/antedom build --site docs -o out  # render it to out/
go run ./engine/cmd/antedom new posts/hello --site docs   # scaffold pages/posts/hello.md
go test ./engine/...
```
